...
class OfficerAgent:
    ...
    def _parse_json(self, text: str, default=None):
        return robust_parse_json(text, default)
...
Return ONLY valid JSON array, no markdown."""),
        ...
        try:
            ...
            result = self._parse_json(chain.invoke({
                "company_name": company_name,
                "snippets": json.dumps(all_snippets, indent=2),
                "extra_text": f"Additional text (Wikipedia/website):\n{extra_text}" if extra_text else "",
            }).content, [])
...
Return ONLY valid JSON object, no markdown."""),
        ...
        try:
            ...
            result = self._parse_json(chain.invoke({
                ...
                "search_results": json.dumps(slim, indent=2),
            }).content, {})
